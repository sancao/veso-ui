                ...
                <div class="column is-8 is-offset-2">
                  <form>
                      ...
                      <div class="columns">
                        ...
                        <div class="column">
                          <label class="label">Mệnh giá</label>
                          <div class="select is-primary">
                            <select>
                              <option>10.000 đồng</option>
                              <option>20.000 đồng</option>
                              <option>50.000 đồng</option>
                            </select>
                          </div>
                        </div>
                      </div>
                      ...
                      <label class="label">Đài dự thưởng</label>
                      <div class="select is-primary">
                        <select>
                          <option>Tất cả</option>
                          <option>Đài Vĩnh Long</option>
                          <option>Đài Long an</option>
                        </select>
                      </div>
